...
class RiemannianMetric(Metric):
    ...
    def __init__(self, mesh, metric_parameters={}):
        ...
        self.V = firedrake.TensorFunctionSpace(mesh, "CG", 1)
        self.function = firedrake.Function(self.V)
    ...
    def set_metric_parameters(self, metric_parameters={}):
        ...
        # with dmhooks.add_hooks(self.plex, opts):
        self.plex.metricSetFromOptions()  # FIXME
